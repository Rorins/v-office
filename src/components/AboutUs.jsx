...
export default function AboutUs(props) {
  ...
  return (
    <div className="options_modal aboutus_modal shadow-2xl">
        ...
        <div>
            <h1>About us</h1>
           <h2>We happen to be two married developers.</h2> 
           <p className="aurora"><span>Aurora</span>:I discovered the magical world of coding in my mid twenties,
            ...
            <p className="davide">
            <span>Davide</span>: Graduated in a technical IT institute, IT has always been a part of my life.
            ...
            <div>
                We love to develop applications together, contact us on linkedin with <span>Aurora Grippaudo and Davide Santonocito</span>. 
            <FontAwesomeIcon
       ...
       />
         ...
         <div>
         <button  onClick={props.onClose}  className="modal_confirm_button">Close</button>
         </div>
