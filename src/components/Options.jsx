...
<div className="flex checkbox p-2 items-center bg-black pl-4 border border-gray-200 rounded">
    <input onChange={(e) => setShowAboutYou(e.target.checked)} id="bordered-checkbox-1" type="checkbox" value="" name="bordered-checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 :focus:ring-blue-600 " />
